...
$pageTitle = "Admin Tools - Delete Review | PHPMotors";
...
<div id="container" class="padding">
  ...
  <p><a href="/phpmotors/accounts/">&#8592; Back</a></p>
  ...
  <fieldset>
        ...
        <label for="reviewText">Review:<br>
          <textarea name="reviewText" id="reviewText" disabled>
                 <?php if (isset($reviewInfo)) {echo $reviewInfo['reviewText'];}?></textarea>
        </label>
        <input type="submit" class="addButton" id="deleteButton"  name="submit" value="Delete Review">

...
$pageTitle = 'PHPMotors Images Uploads';
//gets Categories function from main-model.php
...
//========================================
  ...
  case 'upload':
    ...
    if($imageCheck){
      ...
      if ($result) {
        $message = '<p class="error">The upload succeeded.</p>';
      } else {
...
// Set a message based on the delete result
  if ($remove) {
    $message = "<p class='error'>$filename was successfully deleted.</p>";
  } else {
